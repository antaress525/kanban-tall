...
>
    ...
    <div @click.outside="close" x-cloak x-transition x-show="open" class="fixed top-3.5 bottom-3.5 left-62.5 flex flex-col bg-white shadow-lg border border-neutral-100 rounded-lg w-full max-w-xs">
        <!-- Header -->
